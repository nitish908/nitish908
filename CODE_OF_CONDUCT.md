...
reported to the maintainers as described in [SECURITY.md](./SECURITY.md)'s
contact process (the same channel is used for conduct reports pending a
dedicated address, since both need a private, non-public reporting path).
